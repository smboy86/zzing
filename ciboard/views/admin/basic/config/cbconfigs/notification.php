			  ...
			  <div class="form-group">
				...
				<div class="col-sm-10">
					  ...
					  <input type="checkbox" name="use_notification" id="use_notification" value="1"  <?php echo set_checkbox('use_notification', '1', (element('use_notification', element('data', $view))?TRUE:FALSE)); ?> /> 사용합니다
						...
						<label class=" form-inline" style="padding-top:7px;padding-left:10px;"><span class="fa fa-bell-o"></span>
						<a href="<?php echo site_url('notification'); ?>" target="_blank"><?php echo site_url('notification'); ?></a></label>
