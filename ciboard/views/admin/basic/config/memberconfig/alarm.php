...
//<![CDATA[
	...
	$(function() {
		 $('#send_email_register_alluser').change(function() {
			 if ($(this).is(':checked')) {
	...
	<?php if (element('send_email_register_alluser', element('data', $view))) {?>
		$('#send_email_register_user').prop("checked", false).prop("disabled", true);
	<?php } ?>
		 $('#send_email_register_user').change(function() {
			 if ($(this).is(':checked')) {
	...
	$(function() {
		 $('#send_email_changepw_alluser').change(function() {
			 if ($(this).is(':checked')) {
	...
	<?php if (element('send_email_changepw_alluser', element('data', $view))) {?>
		$('#send_email_changepw_user').prop("checked", false).prop("disabled", true);
	<?php } ?>
		 $('#send_email_changepw_user').change(function() {
			 if ($(this).is(':checked')) {
	...
	$(function() {
		 $('#send_email_memberleave_alluser').change(function() {
			 if ($(this).is(':checked')) {
	...
	<?php if (element('send_email_memberleave_alluser', element('data', $view))) {?>
		$('#send_email_memberleave_user').prop("checked", false).prop("disabled", true);
	<?php } ?>
		 $('#send_email_memberleave_user').change(function() {
			 if ($(this).is(':checked')) {
