...
<input type="hidden" name="is_submit" value="1" />
			<div class="form-horizontal">
			  <div class="form-group">
				...
				<div class="col-sm-10">
						<input type="number" class="form-control" name="change_password_date" id="change_password_date" value="<?php echo set_value('change_password_date', element('change_password_date', element('data', $view))+0); ?>" />
						일,
