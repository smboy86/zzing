...
$(function() {
	$('select').change(function() {    
    	window.location.href = cb_admin_url + '/config/preview/preview/<?php echo element('pagetype', $view)?>?layout='+$('#layout').val()+'&sidebar='+$('#sidebar').val()+'&skin='+$('#skin').val()+'&is_mobile='+$('#is_mobile').val();
	});
