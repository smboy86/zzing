						...
						<div class="table-responsive">
						 <table class="table table-bordered table-hover table-striped">
						  ...
						  <tbody>
							  ...
							  <tr>
								  <th>원글제목</th>
								  <td><div class="textbox"><a href="<?php echo element('posturl', element('data', $view)); ?>" target="_blank"><?php echo html_escape(element('post_title', element('post', element('data', $view)))); ?></a></div></td>
							  </tr>
							  <tr>
								  <th>글쓴이</th>
								  <td><div class="textbox"><?php echo element('cmt_display_name', element('data', $view)); ?></div></td>
							  </tr>
							  <tr>
								  <th>등록일</th>
								  <td><div class="textbox"><?php echo display_datetime(element('cmt_datetime', element('data', $view)),'full') ; ?></div></td>
							  </tr>
							  <tr>
								  <th>댓글내용</th>
