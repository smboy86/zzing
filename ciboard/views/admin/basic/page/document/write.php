...
<input type="hidden" name="<?php echo element('primary_key', $view); ?>"	 value="<?php echo element(element('primary_key', $view), element('data', $view)); ?>" />
			...
			<div class="form-horizontal">
			  ...
			  <div class="form-group">
				...
				사이드바 -
					<select class="form-control" name="doc_mobile_idebar" id="doc_mobile_idebar">
						<option value="">기본설정따름</option>
						<option value="1" <?php echo set_select('doc_mobile_idebar', '1', (element('doc_mobile_idebar', element('data', $view)) == '1'?TRUE:FALSE)); ?> >사용</option>
						<option value="2" <?php echo set_select('doc_mobile_idebar', '2', (element('doc_mobile_idebar', element('data', $view)) == '2'?TRUE:FALSE)); ?> >사용하지않음</option>
					</select>
				스킨 - 
