			  ...
			  <div class="form-group">
				...
				<div class="col-sm-10 form-inline">
					<select name="mem_level"  class="form-control">
						<?php
							for ($i=1 ; $i<= element('config_max_level', element('data', $view)); $i++) {
						?>
								<option value="<?php echo $i; ?>" <?php echo set_select('mem_level', $i, (element('mem_level', element('data', $view)) == $i?TRUE:FALSE)); ?>><?php echo $i; ?></option>
						<?php
							}
						?>
					</select>
...
?>
								<input type="file" name="mem_photo" id="mem_icon"  />
			  ...
			  <div class="form-group">
				...
				<div class="col-sm-10 form-inline">
						<select name="mem_denied" class="form-control">
							...
							<option value="1" <?php echo set_select('mem_denied',  '1', (element('mem_denied', element('data', $view)) == '1'?TRUE:FALSE)); ?>>탈퇴함</option>
							<option value="2" <?php echo set_select('mem_denied',  '2', (element('mem_denied', element('data', $view)) == '2'?TRUE:FALSE)); ?>>관리자가 강제로 차단</option>
						</select>
				</div>
			  </div>
			  <div class="form-group">
