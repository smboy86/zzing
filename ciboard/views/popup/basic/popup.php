...
?>
	<div id="popup_layer_<?php echo element('pop_id', $result); ?>" class="popup_layer" style="top:<?php echo element('pop_top', $result); ?>px;left:<?php echo element('pop_left', $result); ?>px">
		...
		<div class="popup_layer_footer">
			<?php if (element('pop_disable_hours', $result)) { ?><button class="popup_layer_reject"  data-wrapper-id="popup_layer_<?php echo element('pop_id', $result); ?>"  data-disable-hours="<?php echo element('pop_disable_hours', $result); ?>"><strong><?php echo element('pop_disable_hours', $result); ?></strong>시간 동안 열지 않기</button><?php } ?>
