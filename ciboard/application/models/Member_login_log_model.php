...
class Member_login_log_model extends CB_Model
{
    ...
    public function get_login_success_count($type = 'd', $start_date = '', $end_date = '')
    {
        ...
        $this->db->order_by('mll_datetime', 'desc');
    ...
    public function get_login_fail_count($type = 'd', $start_date = '', $end_date = '')
    {
        if (empty($start_date) OR empty($end_date)) {
            return false;
        }
