...
class Scrap_model extends CB_Model {
	...
	*/
	...
	{
		$select = 'scrap.*, post.mem_id as post_mem_id, post.post_userid, post.post_nickname, post.post_id, post.brd_id, post.post_datetime, post.post_hit, post.post_secret, post.post_title, post.post_like, post.post_dislike, post.post_image';
