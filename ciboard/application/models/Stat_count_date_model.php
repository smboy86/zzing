...
class Stat_count_date_model extends CB_Model
{
    ...
    public function get_by_time_day($start_date = '', $end_date = '')
    {
    ...
    public function get_by_time_month($start_date = '', $end_date = '')
    {
        if (empty($start_date) OR empty($end_date)) {
            return false;
        }
    ...
    public function get_by_time_year($start_date = '', $end_date = '')
    {
        if (empty($start_date) OR empty($end_date)) {
            return false;
        }
    ...
    public function get_by_time_week($start_date = '', $end_date = '')
    {
        if (empty($start_date) OR empty($end_date)) {
            return false;
        }
