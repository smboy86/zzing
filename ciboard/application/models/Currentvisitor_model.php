...
class Currentvisitor_model extends CB_Model {
	...
	*/
	...
	function add_visitor($cur_ip='', $mem_id='', $cur_mem_name='', $cur_datetime='', $cur_page='', $cur_url='', $cur_referer='', $cur_useragent='')
	{
	...
	public function get_current_list($curdatetime='', $limit = '', $offset = '')
	{
		...
		$this->db->or_where('member.mem_is_admin IS NULL');
		$this->db->group_end();
	...
	{
		if( ! $curdatetime) $curdatetime = cdate('Y-m-d H:i:s',  ctimestamp() - 600);
