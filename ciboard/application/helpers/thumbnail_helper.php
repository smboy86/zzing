...
{
	function thumb_url($type='', $filename='', $thumb_width=0, $thumb_height=0, $is_create=FALSE, $is_crop=TRUE, $crop_mode='center', $is_sharpen=false, $um_value='80/0.5/3')
	{
		if ( ! $type OR ! $filename) {
			$filename = 'noimage.gif';
			$thumb = thumbnail('', $filename, $thumb_width, $thumb_height, $is_create, $is_crop, $crop_mode, $is_sharpen, $um_value);
			return site_url($thumb);
		}

		$thumb = thumbnail($type, $filename, $thumb_width, $thumb_height, $is_create, $is_crop, $crop_mode, $is_sharpen, $um_value);
...
if ( ! function_exists('thumbnail'))
{
	...
	function thumbnail($type='', $filename='', $thumb_width=0, $thumb_height=0, $is_create=FALSE, $is_crop=TRUE, $crop_mode='center', $is_sharpen=false, $um_value='80/0.5/3')
	{
