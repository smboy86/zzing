...
class Board extends CI_Controller
{
     ...
     */
    public function get_baord($brd_id = 0, $brd_key = '')
    {
    ...
    public function delete_post($post_id = 0)
    {
        ...
        if (element('point_post_delete', $board)
            && $this->CI->member->item('mem_id') === element('mem_id', $post)) {
    ...
    public function delete_comment($cmt_id = 0)
    {
        ...
        } elseif (element('point_admin_comment_delete', $board) && $this->CI->member->item('mem_id') !== element('mem_id', $comment)) {
