...
class Notificationlib extends CI_Controller
{
	...
	function __construct()
	{
		...
		$this->CI->load->model( array('Notification_model', 'Member_meta_model'));
	...
	/**
	  * 알림 내용을 인서트하는 함수입니다
	  */
	public function set_noti($mem_id='', $target_mem_id='' , $not_type='', $not_content_id='', $not_message='', $not_url='')
	{
		if ( ! $mem_id) {
