...
class Currentvisitor extends CB_Controller
{
	...
	*/
	public function index()
	{
		...
		if ( ! $this->cbconfig->item('open_currentvisitor') && $this->member->is_admin() != 'super') {
		...
		*/
		...
		$minute = $this->cbconfig->item('currentvisitor_minute') ;
		...
		if ( ! $result = $this->cache->get($cachename)) {
			$this->Currentvisitor_model->delete('', array('cur_datetime < ' => $curdatetime));
