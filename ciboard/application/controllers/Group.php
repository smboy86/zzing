...
class Group extends CB_Controller
{
	...
	*  모델을 로딩합니다
	*/
	protected $models = array('Board_group');
	...
	*/
	...
	function __construct()
	{
		...
		*  라이브러리를 로딩합니다
		*/
		$this->load->library(array('pagination', 'querystring', 'board_group'));
	}
	...
	*/
	public function index($bgr_key = '')
	{
		...
		$board_id = $this->Board_model->get($primary_value='' , $select = 'brd_id', array('bgr_id' => element('bgr_id', $group), 'brd_search' => '1'), '' , '', $findex = 'brd_order', $forder = 'ASC');
		$board_list = array();
