...
class Formmail extends CB_Controller
{
	...
	*  모델을 로딩합니다
	*/
	protected $models = array('Member', 'Member_meta');
	...
	*/
	public function write($userid = '')
	{
		...
		$view['view']['member'] = $member = $this->Member_model->get_by_userid($userid, 'mem_id, mem_denied, mem_receive_email, mem_nickname, mem_email');
		...
		*/
		if ($this->form_validation->run() == FALSE) {
			...
			*/
			...
			$this->email->mailtype = $this->cbconfig->item('use_formmail_dhtml') ? 'html' : 'text';
