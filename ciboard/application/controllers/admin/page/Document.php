...
class Document extends CB_Controller
{
	...
	*  모델을 로딩합니다
	*/
	protected $models = array('Document', 'Member');
	...
	*/
	public function write($pid = '')
	{
		...
		*/
		$config = array(
			array('field'=>'doc_title', 'label'=>'제목', 'rules'=>'trim|required'),
			array('field'=>'doc_content', 'label'=>'내용', 'rules'=>'trim|required'),
			array('field'=>'doc_mobile_content', 'label'=>'모바일내용', 'rules'=>'trim'),
			array('field'=>'doc_layout', 'label'=>'레이아웃', 'rules'=>'trim'),
			array('field'=>'doc_sidebar', 'label'=>'사이드바', 'rules'=>'trim'),
			array('field'=>'doc_skin', 'label'=>'스킨', 'rules'=>'trim'),
			array('field'=>'doc_mobile_layout', 'label'=>'모바일레이아웃', 'rules'=>'trim'),
			array('field'=>'doc_mobile_sidebar', 'label'=>'모바일사이드바', 'rules'=>'trim'),
			array('field'=>'doc_mobile_skin', 'label'=>'모바일스킨', 'rules'=>'trim'),
		);
		...
		*/
		if ($this->form_validation->run() == FALSE) {
			...
			*/
			...
			$updatedata = array(
				'doc_key' => $this->input->post('doc_key'),
				'doc_title' => $this->input->post('doc_title'),
				'doc_content' => $this->input->post('doc_content'),
				'doc_mobile_content' => $this->input->post('doc_mobile_content'),
				'doc_content_html_type' => $content_type,
				'doc_layout' => $this->input->post('doc_layout'),
				'doc_mobile_layout' => $this->input->post('doc_mobile_layout'),
				'doc_sidebar' => $this->input->post('doc_sidebar'),
				'doc_mobile_sidebar' => $this->input->post('doc_mobile_sidebar'),
				'doc_skin' => $this->input->post('doc_skin'),
				'doc_mobile_skin' => $this->input->post('doc_mobile_skin'),
