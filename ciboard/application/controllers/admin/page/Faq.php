	...
	*/
	public function write($pid = '')
	{
		...
		*/
		...
		if ($this->input->get('fgr_id') == '' OR  ! is_numeric($this->input->get('fgr_id')))  show_404();
		...
		*/
		$config = array(
			array('field'=>'fgr_id', 'label'=>'FAQ그룹', 'rules'=>'trim|required|numeric'),
			array('field'=>'faq_order', 'label'=>'정렬순서', 'rules'=>'trim|required|numeric'),
			array('field'=>'faq_title', 'label'=>'질문', 'rules'=>'trim|required'),
			array('field'=>'faq_content', 'label'=>'답변', 'rules'=>'trim|required'),
			array('field'=>'faq_mobile_content', 'label'=>'모바일답변', 'rules'=>'trim'),
		);
		...
		*/
		if ($this->form_validation->run() == FALSE) {
			...
			$view['view']['data']['faqgroup'] = $this->Faq_group_model->get_one($this->input->get('fgr_id'));
			...
			*/
			...
			$updatedata = array(
				'fgr_id' => $this->input->post('fgr_id'),
				'faq_title' => $this->input->post('faq_title'),
				'faq_content' => $this->input->post('faq_content'),
				'faq_mobile_content' => $this->input->post('faq_mobile_content'),
