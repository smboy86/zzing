	...
	public function index()
	{
		...
		*/
		$config = array(
			...
			array('field'=>'layout_default', 'label'=>'기본레이아웃', 'rules'=>'trim|required'),
			array('field'=>'sidebar_default', 'label'=>'기본사이드바', 'rules'=>'trim'),
			array('field'=>'mobile_layout_default', 'label'=>'기본모바일레이아웃', 'rules'=>'trim|required'),
			array('field'=>'mobile_sidebar_default', 'label'=>'기본모바일사이드바', 'rules'=>'trim'),
			array('field'=>'skin_default', 'label'=>'기본일반스킨', 'rules'=>'trim|required'),
			array('field'=>'mobile_skin_default', 'label'=>'기본모바일스킨', 'rules'=>'trim|required'),
			array('field'=>'layout_main', 'label'=>'메인페이지레이아웃', 'rules'=>'trim'),
			array('field'=>'sidebar_main', 'label'=>'메인페이지사이드바', 'rules'=>'trim'),
			array('field'=>'mobile_layout_main', 'label'=>'메인페이지모바일레이아웃', 'rules'=>'trim'),
			array('field'=>'mobile_sidebar_main', 'label'=>'메인페이지모바일사이드바', 'rules'=>'trim'),
			array('field'=>'skin_main', 'label'=>'메인페이지일반스킨', 'rules'=>'trim'),
			array('field'=>'mobile_skin_main', 'label'=>'메인페이지모바일스킨', 'rules'=>'trim'),
			array('field'=>'layout_board', 'label'=>'게시판레이아웃', 'rules'=>'trim'),
			array('field'=>'sidebar_board', 'label'=>'게시판사이드바', 'rules'=>'trim'),
			array('field'=>'mobile_layout_board', 'label'=>'게시판모바일레이아웃', 'rules'=>'trim'),
			array('field'=>'mobile_sidebar_board', 'label'=>'게시판모바일사이드바', 'rules'=>'trim'),
			array('field'=>'skin_board', 'label'=>'게시판일반스킨', 'rules'=>'trim'),
			array('field'=>'mobile_skin_board', 'label'=>'게시판모바일스킨', 'rules'=>'trim'),
			array('field'=>'layout_group', 'label'=>'게시판그룹레이아웃', 'rules'=>'trim'),
			array('field'=>'sidebar_group', 'label'=>'게시판그룹사이드바', 'rules'=>'trim'),
			array('field'=>'mobile_layout_group', 'label'=>'게시판그룹모바일레이아웃', 'rules'=>'trim'),
			array('field'=>'mobile_sidebar_group', 'label'=>'게시판그룹모바일사이드바', 'rules'=>'trim'),
			array('field'=>'skin_group', 'label'=>'게시판그룹일반스킨', 'rules'=>'trim'),
			array('field'=>'mobile_skin_group', 'label'=>'게시판그룹모바일스킨', 'rules'=>'trim'),
			array('field'=>'layout_document', 'label'=>'일반문서레이아웃', 'rules'=>'trim'),
			array('field'=>'sidebar_document', 'label'=>'일반문서사이드바', 'rules'=>'trim'),
			array('field'=>'mobile_layout_document', 'label'=>'일반문서모바일레이아웃', 'rules'=>'trim'),
			array('field'=>'mobile_sidebar_document', 'label'=>'일반문서모바일사이드바', 'rules'=>'trim'),
			array('field'=>'skin_document', 'label'=>'일반문서일반스킨', 'rules'=>'trim'),
			array('field'=>'mobile_skin_document', 'label'=>'일반문서모바일스킨', 'rules'=>'trim'),
			array('field'=>'layout_faq', 'label'=>'FAQ레이아웃', 'rules'=>'trim'),
			array('field'=>'sidebar_faq', 'label'=>'FAQ사이드바', 'rules'=>'trim'),
			array('field'=>'mobile_layout_faq', 'label'=>'FAQ모바일레이아웃', 'rules'=>'trim'),
			array('field'=>'mobile_sidebar_faq', 'label'=>'FAQ모바일사이드바', 'rules'=>'trim'),
			array('field'=>'skin_faq', 'label'=>'FAQ일반스킨', 'rules'=>'trim'),
			array('field'=>'mobile_skin_faq', 'label'=>'FAQ모바일스킨', 'rules'=>'trim'),
			array('field'=>'layout_register', 'label'=>'회원가입레이아웃', 'rules'=>'trim'),
			array('field'=>'sidebar_register', 'label'=>'회원가입사이드바', 'rules'=>'trim'),
			array('field'=>'mobile_layout_register', 'label'=>'회원가입모바일레이아웃', 'rules'=>'trim'),
			array('field'=>'mobile_sidebar_register', 'label'=>'회원가입모바일사이드바', 'rules'=>'trim'),
			array('field'=>'skin_register', 'label'=>'회원가입일반스킨', 'rules'=>'trim'),
			array('field'=>'mobile_skin_register', 'label'=>'회원가입모바일스킨', 'rules'=>'trim'),
			array('field'=>'layout_findaccount', 'label'=>'아이디패스워드찾기레이아웃', 'rules'=>'trim'),
			array('field'=>'sidebar_findaccount', 'label'=>'아이디패스워드찾기사이드바', 'rules'=>'trim'),
			array('field'=>'mobile_layout_findaccount', 'label'=>'아이디패스워드찾기모바일레이아웃', 'rules'=>'trim'),
			array('field'=>'mobile_sidebar_findaccount', 'label'=>'아이디패스워드찾기모바일사이드바', 'rules'=>'trim'),
			array('field'=>'skin_findaccount', 'label'=>'아이디패스워드찾기일반스킨', 'rules'=>'trim'),
			array('field'=>'mobile_skin_findaccount', 'label'=>'아이디패스워드찾기모바일스킨', 'rules'=>'trim'),
			array('field'=>'layout_login', 'label'=>'로그인레이아웃', 'rules'=>'trim'),
			array('field'=>'sidebar_login', 'label'=>'로그인사이드바', 'rules'=>'trim'),
			array('field'=>'mobile_layout_login', 'label'=>'로그인모바일레이아웃', 'rules'=>'trim'),
			array('field'=>'mobile_sidebar_login', 'label'=>'로그인모바일사이드바', 'rules'=>'trim'),
			array('field'=>'skin_login', 'label'=>'로그인일반스킨', 'rules'=>'trim'),
			array('field'=>'mobile_skin_login', 'label'=>'로그인모바일스킨', 'rules'=>'trim'),
			array('field'=>'layout_mypage', 'label'=>'마이페이지레이아웃', 'rules'=>'trim'),
			array('field'=>'sidebar_mypage', 'label'=>'마이페이지사이드바', 'rules'=>'trim'),
			array('field'=>'mobile_layout_mypage', 'label'=>'마이페이지모바일레이아웃', 'rules'=>'trim'),
			array('field'=>'mobile_sidebar_mypage', 'label'=>'마이페이지모바일사이드바', 'rules'=>'trim'),
			array('field'=>'skin_mypage', 'label'=>'마이페이지일반스킨', 'rules'=>'trim'),
			array('field'=>'mobile_skin_mypage', 'label'=>'마이페이지모바일스킨', 'rules'=>'trim'),
			array('field'=>'layout_currentvisitor', 'label'=>'현재접속자레이아웃', 'rules'=>'trim'),
			array('field'=>'sidebar_currentvisitor', 'label'=>'현재접속자사이드바', 'rules'=>'trim'),
			array('field'=>'mobile_layout_currentvisitor', 'label'=>'현재접속자모바일레이아웃', 'rules'=>'trim'),
			array('field'=>'mobile_sidebar_currentvisitor', 'label'=>'현재접속자모바일사이드바', 'rules'=>'trim'),
			array('field'=>'skin_currentvisitor', 'label'=>'현재접속자일반스킨', 'rules'=>'trim'),
			array('field'=>'mobile_skin_currentvisitor', 'label'=>'현재접속자모바일스킨', 'rules'=>'trim'),
			array('field'=>'layout_search', 'label'=>'검색페이지레이아웃', 'rules'=>'trim'),
			array('field'=>'sidebar_search', 'label'=>'검색페이지사이드바', 'rules'=>'trim'),
			array('field'=>'mobile_layout_search', 'label'=>'검색페이지모바일레이아웃', 'rules'=>'trim'),
			array('field'=>'mobile_sidebar_search', 'label'=>'검색페이지모바일사이드바', 'rules'=>'trim'),
			array('field'=>'skin_search', 'label'=>'검색페이지일반스킨', 'rules'=>'trim'),
			array('field'=>'mobile_skin_search', 'label'=>'검색페이지모바일스킨', 'rules'=>'trim'),
			array('field'=>'layout_note', 'label'=>'쪽지레이아웃', 'rules'=>'trim'),
			array('field'=>'mobile_layout_note', 'label'=>'쪽지모바일레이아웃', 'rules'=>'trim'),
			array('field'=>'skin_note', 'label'=>'쪽지스킨', 'rules'=>'trim'),
			array('field'=>'mobile_skin_note', 'label'=>'쪽지모바일스킨', 'rules'=>'trim'),
			array('field'=>'layout_profile', 'label'=>'프로필레이아웃', 'rules'=>'trim'),
			array('field'=>'mobile_layout_profile', 'label'=>'프로필모바일레이아웃', 'rules'=>'trim'),
			array('field'=>'skin_profile', 'label'=>'프로필스킨', 'rules'=>'trim'),
			array('field'=>'mobile_skin_profile', 'label'=>'프로필모바일스킨', 'rules'=>'trim'),
			array('field'=>'layout_formmail', 'label'=>'폼메일레이아웃', 'rules'=>'trim'),
			array('field'=>'mobile_layout_formmail', 'label'=>'폼메일모바일레이아웃', 'rules'=>'trim'),
			array('field'=>'skin_formmail', 'label'=>'폼메일스킨', 'rules'=>'trim'),
			array('field'=>'mobile_skin_formmail', 'label'=>'폼메일모바일스킨', 'rules'=>'trim'),
			array('field'=>'layout_notification', 'label'=>'알림레이아웃', 'rules'=>'trim'),
			array('field'=>'sidebar_notification', 'label'=>'알림사이드바', 'rules'=>'trim'),
			array('field'=>'mobile_layout_notification', 'label'=>'알림모바일레이아웃', 'rules'=>'trim'),
			array('field'=>'mobile_sidebar_notification', 'label'=>'알림모바일사이드바', 'rules'=>'trim'),
			array('field'=>'skin_notification', 'label'=>'알림스킨', 'rules'=>'trim'),
			array('field'=>'mobile_skin_notification', 'label'=>'알림모바일스킨', 'rules'=>'trim'),
			array('field'=>'layout_helptool', 'label'=>'헬프툴레이아웃', 'rules'=>'trim'),
			array('field'=>'mobile_layout_helptool', 'label'=>'헬프툴모바일레이아웃', 'rules'=>'trim'),
			array('field'=>'skin_helptool', 'label'=>'헬프툴스킨', 'rules'=>'trim'),
			array('field'=>'mobile_skin_helptool', 'label'=>'헬프툴모바일스킨', 'rules'=>'trim'),
			array('field'=>'skin_popup', 'label'=>'팝업스킨', 'rules'=>'trim'),
			array('field'=>'mobile_skin_popup', 'label'=>'팝업모바일스킨', 'rules'=>'trim'),
		);
	...
	*/
	public function metatag()
	{
		...
		*/
		$config = array(
			array('field'=>'is_submit', 'label'=>'전송', 'rules'=>'trim|numeric'),
			array('field'=>'site_meta_title_default', 'label'=>'기본설정 Title', 'rules'=>'trim'),
			array('field'=>'site_meta_description_default', 'label'=>'기본설정 meta description', 'rules'=>'trim'),
			array('field'=>'site_meta_keywords_default', 'label'=>'기본설정 meta keywords', 'rules'=>'trim'),
			array('field'=>'site_meta_author_default', 'label'=>'기본설정 meta author', 'rules'=>'trim'),
		);
		foreach($pagelist as $pval) {
			$config[] = array('field'=>'site_meta_title_' . element('key', $pval), 'label'=> element('name', $pval) . ' Title', 'rules'=>'trim');
			$config[] = array('field'=>'site_meta_description_' . element('key', $pval), 'label'=> element('name', $pval) . ' meta description', 'rules'=>'trim');
			$config[] = array('field'=>'site_meta_keywords_' . element('key', $pval), 'label'=> element('name', $pval) . ' meta keywords', 'rules'=>'trim');
			$config[] = array('field'=>'site_meta_author_' . element('key', $pval), 'label'=> element('name', $pval) . ' meta author', 'rules'=>'trim');
			$config[] = array('field'=>'site_page_name_' . element('key', $pval), 'label'=> element('name', $pval) . ' page name', 'rules'=>'trim');
		}
		$this->form_validation->set_rules($config);
