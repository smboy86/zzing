...
class Memberfollow extends CB_Controller
{
	...
	*  모델을 로딩합니다
	*/
	protected $models = array('Follow', 'Member');
		...
		*/
		...
		if (element('list', $result)) {
			foreach (element('list', $result) as $key => $val) {
				...
				$result['list'][$key]['display_name'] =  display_username(element('mem_userid', $dbmember), element('mem_nickname', $dbmember), element('mem_icon', $dbmember));
