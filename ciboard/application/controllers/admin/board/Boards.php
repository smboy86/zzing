...
class Boards extends CB_Controller
{
    ...
    protected $models = array(
        'Board', 'Board_meta', 'Member',
        'Config', 'Board_admin',
        'Post_extra_vars', 'Board_category', 'Board_group');
    ...
    public function write_post($pid = 0)
    {
        ...
        if ($this->form_validation->run() === false) {
            ...
            $array = array('use_scrap', 'use_post_like', 'use_post_dislike', 'use_print',
                ...
                'use_auto_url', 'use_mobile_auto_url',);
    ...
    public function write_general($pid = 0)
    {
        ...
        if ($this->form_validation->run() === false) {
            ...
            $array = array('protect_post_day', 'protect_comment_day', 'protect_comment_num', 
                'use_sideview', 'use_mobile_sideview', 'use_category',
                'category_display_style', 'mobile_category_display_style', 'use_naver_syndi',
                'use_personal', 'use_tempsave', 'use_post_delete_log',
    ...
    public function write_rss($pid = 0)
    {
        ...
        if ($this->form_validation->run() === false) {
            ...
            $array = array('use_rss_feed', 'use_rss_total_feed', 'rss_feed_content',
                'rss_feed_description', 'rss_feed_copyright', 'rss_feed_post_count');
    ...
    public function listdelete()
    {
        ...
        $this->load->model(array(
            'Blame_model', 'Comment_model', 'Like_model', 'Post_model',
            'Post_extra_vars_model', 'Post_file_model', 'Post_link_model', 'Post_meta_model',
            'Scrap_model', 'Stat_count_board_model', 'Tempsave_model'));
