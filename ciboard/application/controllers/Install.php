...
class Install extends CI_Controller
{
	...
	*/
	...
	public function step2()
	{
		...
		} else if ( !(is_readable($uploads_dir) && is_writeable($uploads_dir))) {
			$install_avaiable = FALSE;
		...
		} else if ( !(is_readable($cache_dir) && is_writeable($cache_dir))) {
			$install_avaiable = FALSE;
		...
		} else if ( !(is_readable($log_dir) && is_writeable($log_dir))) {
			$install_avaiable = FALSE;
	...
	public function step3()
	{
		...
		if (config_item('encryption_key') != '') {
			...
			$message .= "application/config/config.php 의 config['encryption_key'] 에 내용을 입력해주세요, 현재 그 값이 비어있습니다. 한번 입력하신 값은 변경하지 말아주세요. 패스워드 암호화에 사용됩니다<br />";
		}
		...
		if (config_item('base_url') != '') {
			...
			$message .= "application/config/config.php 의 config['base_url'] 에 현재 사이트 주소를 입력해주세요, 현재 그 값이 비어있습니다<br />";
		}
	...
	public function step4()
	{
		...
		/*
		$view['title1'] = 'hostname';
		if ($dbinfo['hostname'] != '') {
			$view['content1'] = '<span class="bold color_blue">설정완료</span>';
		} else {
			$install_avaiable = FALSE;
			$view['content1'] = '<span class="bold color_red">비어있음</span>';
			$message .= "application/config/database.php 의 db['default']['hostname'] 에 데이터베이스 정보를 입력해주세요<br />";
		}
		*/
		...
		if ($dbinfo['username'] != '') {
			...
			$install_avaiable = FALSE;
			$view['content2'] = '<span class="bold color_red">비어있음</span>';
			$message .= "application/config/database.php 의 db['default']['username'] 에 데이터베이스 정보를 입력해주세요<br />";
		}
		...
		if ($dbinfo['password'] != '') {
			...
			$message .= "application/config/database.php 의 db['default']['password'] 에 데이터베이스 정보를 입력해주세요<br />";
		}
		...
		if ($dbinfo['database'] != '') {
			...
			$message .= "application/config/database.php 의 db['default']['database'] 에 데이터베이스 정보를 입력해주세요<br />";
		}
	...
	public function step5()
	{
		...
		$config = array();
		$config['mem_userid'] = array('field'=>'mem_userid', 'label'=>'User ID', 'rules'=>'trim|alphanumunder|min_length[3]|max_length[20]');
		$config['mem_password'] = array('field'=>'mem_password', 'label'=>'패스워드', 'rules'=>'trim|min_length[4]');
		$config['mem_password_re'] = array('field'=>'mem_password_re', 'label'=>'패스워드 확인', 'rules'=>'trim|required|min_length[4]|matches[mem_password]');
		$config['mem_nickname'] = array('field'=>'mem_nickname', 'label'=>'닉네임', 'rules'=>'trim|min_length[2]|max_length[20]|callback__mem_nickname_check');
		$config['mem_email'] = array('field'=>'mem_email', 'label'=>'이메일', 'rules'=>'trim|valid_email|max_length[50]');
		$config['skin'] = array('field'=>'skin', 'label'=>'스킨', 'rules'=>'trim|required');
		$form_validation = '';
...
flvr.pandora.tv',
		...
		$registerform = array
			(
				'mem_userid' => array('field_name' => 'mem_userid', 'func' => 'basic', 'display_name' => '아이디', 'field_type' => 'text', 'use' => '1', 'open' => '1', 'required' => '1'),
				'mem_email' => array('field_name' => 'mem_email', 'func' => 'basic', 'display_name' => '이메일주소', 'field_type' => 'email', 'use' => '1', 'open' => '', 'required' => '1'),
				'mem_password' => array('field_name' => 'mem_password', 'func' => 'basic', 'display_name' => '비밀번호', 'field_type' => 'password', 'use' => '1', 'open' => '', 'required' => '1'),
				'mem_username' => array('field_name' => 'mem_username', 'func' => 'basic', 'display_name' => '이름', 'field_type' => 'text', 'use' => '', 'open' => '', 'required' => ''),
				'mem_nickname' => array('field_name' => 'mem_nickname', 'func' => 'basic', 'display_name' => '닉네임', 'field_type' => 'text', 'use' => '1', 'open' => '1', 'required' => '1'),
				'mem_homepage' => array('field_name' => 'mem_homepage', 'func' => 'basic', 'display_name' => '홈페이지', 'field_type' => 'url', 'use' => '', 'open' => '1', 'required' => ''),
				'mem_phone' => array('field_name' => 'mem_phone', 'func' => 'basic', 'display_name' => '전화번호', 'field_type' => 'phone', 'use' => '', 'open' => '', 'required' => ''),
				'mem_birthday' => array('field_name' => 'mem_birthday', 'func' => 'basic', 'display_name' => '생년월일', 'field_type' => 'date', 'use' => '', 'open' => '', 'required' => ''),
				'mem_sex' => array('field_name' => 'mem_sex', 'func' => 'basic', 'display_name' => '성별', 'field_type' => 'radio', 'use' => '', 'open' => '', 'required' => ''),
				'mem_address' => array('field_name' => 'mem_address', 'func' => 'basic', 'display_name' => '주소', 'field_type' => 'address', 'use' => '', 'open' => '', 'required' => ''),
				'mem_profile_content' => array('field_name' => 'mem_profile_content', 'func' => 'basic', 'display_name' => '자기소개', 'field_type' => 'textarea', 'use' => '', 'open' => '1', 'required' => ''),
				'mem_recommend' => array('field_name' => 'mem_recommend', 'func' => 'basic', 'display_name' => '추천인', 'field_type' => 'text', 'use' => '', 'open' => '', 'required' => ''),
			);
