	...
	*/
 	...
 	public function index()
	{
		...
		*/
		...
		$sfield = $sfield2 = $param->get('sfield');
		$sop = $param->get('sop');
		if ($sfield == 'post_both') {
		...
		*/
		...
		$group_id = $this->input->get('group_id') && is_numeric($this->input->get('group_id')) ? $this->input->get('group_id') : '';
		$board_id = $this->input->get('board_id') && is_numeric($this->input->get('board_id')) ? $this->input->get('board_id') : '';
		...
		$boardlisttmp = $this->Board_model->get('' , '', $boardwhere, '' , 0, 'brd_order', 'ASC');
		$boardlist = array();
